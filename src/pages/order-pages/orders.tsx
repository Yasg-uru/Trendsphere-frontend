...
import { ChevronDown, ChevronUp, Package, CreditCard, MapPin, Calendar } from 'lucide-react'
          ...
          <Card key={order._id} className="border border-border">
            <CardHeader className="bg-muted">
              <div className="flex justify-between items-center">
                <CardTitle className="text-lg font-medium text-foreground">Order #{order._id}</CardTitle>
                <Badge className={`${getStatusColor(order.orderStatus)} px-2 py-1 text-xs font-medium`}>
                  {order.orderStatus}
                </Badge>
              </div>
                ...
                >
                  <CardContent>
                    <ScrollArea className="h-[300px] w-full rounded-md border border-border p-4">
                      ...
                      <Separator className="my-3" />
                      <h4 className="font-medium mb-2 text-foreground">Payment</h4>
