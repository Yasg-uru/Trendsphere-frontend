...
//   // Update totalItems calculation to exclude unavailable items
//   const totalItems = carts.reduce((acc, item) => {
//     return isAvailable(item.stocks) ? acc + item.quantity : acc;
//   }, 0);

//   // Update totalCost calculation to exclude unavailable items
//   const totalCost = carts.reduce((acc, item: any) => {
//     if (!isAvailable(item.stocks)) return acc; // Skip unavailable items
...
//   // TotalPriceWithoutDiscount should also skip unavailable items
...
//   console.log(
//     "this is a totalpoints without discounrt ",
//     TotalPriceWithoutDiscount
//   );
//   console.log("this is a discounted price :", totalCost);
